...
VERSION="$(tr -d '[:space:]' < "$ROOT/VERSION")"   # single source of truth: the VERSION file
BUILD_DIR="$ROOT/dist"
...
<defs>
  <linearGradient id="g" x1="0" y1="0" x2="1" y2="1">
    ...
    <stop offset="0.45" stop-color="#72e7ff"/>
    <stop offset="1" stop-color="#8c4dff"/>
  </linearGradient>
  <filter id="s"><feDropShadow dx="0" dy="24" stdDeviation="30" flood-opacity="0.25"/></filter>
</defs>
...
<circle cx="742" cy="642" r="64" fill="#7728ff"/>
<circle cx="742" cy="642" r="28" fill="#07e6ff"/>
</svg>''')
